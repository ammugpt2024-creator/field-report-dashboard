...
export const FIELD_ENGINEER_NAV = [
  ...
  { label: "Drafts", path: "/technician/dashboard?view=daily-logs", icon: PenLine, nested: true },
  { label: "Submitted", path: "/technician/dashboard?view=submitted-logs", icon: SendHorizontal, nested: true },
  { label: "Returned", path: "/technician/dashboard?view=returned-logs", icon: Undo2, nested: true },
  { label: "Approved", path: "/technician/dashboard?view=approved-logs", icon: CheckCircle2, nested: true },
  { section: "Workforce" },
